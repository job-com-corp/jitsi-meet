...
--
--        api_prefix = "https://external_app.domain.com/api"
--
...
local URL_EVENT_ROOM_CREATED = api_prefix..'/prosody/events/room/created';
local URL_EVENT_ROOM_DESTROYED = api_prefix..'/prosody/events/room/destroyed';
